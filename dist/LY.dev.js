...
class MyNode {
    ...
    _init(selector) {
         ...
         * Array
         */
        if (typeof selector === 'object' && _util_js__WEBPACK_IMPORTED_MODULE_0__["default"].isArrayLike(selector) && _util_js__WEBPACK_IMPORTED_MODULE_0__["default"].type(selector.forEach) === 'function') {
    ...
    before(content, pos = 0) {
        ...
        if (content instanceof MyNode) {
            ...
            _util_js__WEBPACK_IMPORTED_MODULE_0__["default"].isArrayLike(content) &&
            _util_js__WEBPACK_IMPORTED_MODULE_0__["default"].type(content.forEach) === 'function'
        ) {
